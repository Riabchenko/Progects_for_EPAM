...
*
*/
public class Alexandrite extends Stones{	
	TypeStones type = TypeStones.ALEXANDRITE;
	Forma forma;
	Color color;
	Clarity clarity;
	Cut cut;
	...
	/**
	 * It's constructor for create Alexandrite
	 * @param forma
	 ...
	 * @param cut
	 */
	private Alexandrite (Forma forma,float diametrOrLenght, float widht,float height,Color color,Clarity clarity, Cut cut){
		this.forma = forma;
		this.color = color;
	...
	/**
	 * It's static class creates object of Alexandrite
	 * @author Aliona
	 *
	 */
	public static class Factory implements com.intellect25.task1.stones.Factory<Alexandrite> {
		/*
		 * (non-Javadoc)
		 ...
		 */
		public Alexandrite create(Forma forma,float diametrOrLenght, float widht,float height,Color color,Clarity clarity, Cut cut){
			return new Alexandrite(forma,diametrOrLenght,widht,height,color,clarity,cut);
		}
	}
	
	/**
	 * Method sets weight of the Alexandrite which depends on many parameters  
	 * @param forma
	 * @param diametrOrLenght
	 * @param widht
	 * @param height
	...
	/**
	 * Method sets price of the Alexandrite which depends on many parameters  
	 * @param weight
	 * @param color
	 * @param clarity
	 * @param cut
