...
public class Sapphire extends Stones{	
	TypeStones type = TypeStones.SAPPHIRE;
	Forma forma;
	Color color;
	Clarity clarity;
	Cut cut;
	double 
			...
			BASE_PRICE = 0.7;
	/**
	 * It's constructor for create Sapphire
	 * @param forma
	 ...
	 * @param cut
	 */
	private Sapphire (Forma forma,float diametrOrLenght, float widht,float height,Color color,Clarity clarity, Cut cut){
		this.forma = forma;
		this.color = color;
	...
	/**
	 * It's static class creates object of Sapphire
	 * @author Aliona
	 *
	 */
	public static class Factory implements com.intellect25.task1.stones.Factory<Sapphire> {
		/*
		 * (non-Javadoc)
		 ...
		 */
		public Sapphire create(Forma forma,float diametrOrLenght, float widht,float height,Color color,Clarity clarity, Cut cut){
			return new Sapphire(forma,diametrOrLenght,widht,height,color,clarity,cut);
		}
	}
	
	/**
	 * Method sets weight of the Sapphire which depends on many parameters  
	 * @param forma
	 * @param diametrOrLenght
	 * @param widht
	 * @param height
	...
	private double getWeightForSet(Forma forma,float diametrOrLenght,float widht,float height){
		return round((diametrOrLenght*widht*height*TypeStones.SAPPHIRE.getDensity()*forma.getProperty()),2);
	}
	
	/**
	 * Method sets price of the Sapphire which depends on many parameters  
	 * @param weight
	 * @param color
	 * @param clarity
	 * @param cut
